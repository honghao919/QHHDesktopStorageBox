...
public sealed class DesktopBoxWindowTemplateTests
{
    ...
    public void SelectionStyles_AreLoadedFromAnIsolatedResourceDictionary()
    {
        ...
        Assert.Contains(
            "/QHHDesktopStorageBox.App;component/Views/Styles/DesktopBoxSelectionStyles.xaml",
            sources);
        Assert.Contains(
            "/QHHDesktopStorageBox.App;component/Views/Styles/DesktopBoxControlStyles.xaml",
            sources);
    }
