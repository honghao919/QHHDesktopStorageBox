; QHHDesktopStorageBox Inno Setup script
; Build: ISCC.exe QHHDesktopStorageBox.iss
...
;   PublishDir     — the dotnet publish output folder containing QHHDesktopStorageBox.App.exe
;
...
#ifndef PublishDir
  #define PublishDir "..\publish\v1.3.15"
#endif

#define MyAppName "QHH Desktop Storage Box"
#define MyAppPublisher "QHH"
#define MyAppURL "https://github.com/honghao919/QHHDesktopStorageBox"
#define MyAppExeName "QHHDesktopStorageBox.App.exe"
...
OutputDir=..\publish
OutputBaseFilename=QHHDesktopStorageBox-Setup-v{#MyAppVersion}-x64
SetupIconFile=..\src\QHHDesktopStorageBox.App\Assets\app.ico
...
Name: "{group}\用户说明书"; Filename: "{app}\QHH-Desktop-Storage-Box-User-Manual.pdf"
