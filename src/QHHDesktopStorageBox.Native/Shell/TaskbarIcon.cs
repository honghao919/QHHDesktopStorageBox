...
namespace QHHDesktopStorageBox.Native.Shell;
...
public sealed class TaskbarIcon : IDisposable
{
    ...
    public TaskbarIcon(nint ownerWindowHandle, string iconPath, string tooltip)
    {
        ...
        _tooltip = tooltip;
        _callbackMessageId = NativeMethods.RegisterWindowMessageW("QHHDesktopStorageBox.TaskbarIcon.Callback");
    ...
    private sealed class NativeWindow : IDisposable
    {
        ...
        public NativeWindow(uint callbackMessageId, TaskbarIcon owner)
        {
            ...
            var className = "QHHDesktopStorageBoxNotifyIcon_" + Guid.NewGuid().ToString("N");
            _wndProc = WndProc;
